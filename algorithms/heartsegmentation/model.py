from keras.layers import Input, Conv2D, MaxPooling2D, AveragePooling2D, Conv2DTranspose, Concatenate, Dropout, Activation, Dense, UpSampling2D, BatchNormalization
import numpy as np
...
==================================================================================================='''
def unet(x_in, k_size=3, optimizer='adam', depth = 4, downsize_filters_factor = 1, batch_norm = False, activation='relu', initializer='glorot_uniform', seed=42, upsampling = False, dropout = [(-1, 0.5)], n_convs_per_layer=2, lr= False, loss='binary'):
    ...
    if settings['dropout']!=False:
        ...
        dropouts = {dropout_depths[d]:rate for d, rate in settings['dropout']} # apply to the last layer with 0.5 rate..
